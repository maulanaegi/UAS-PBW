  ...
  <div class="container-fluid">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Unsap</span>Perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">Unsap Perpus</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Anisa Nida Farid Faris</div>
        <div class="card-body">
          <h5 class="card-title">IF V-E</h5>
        </div>
      </div>
    </div>
    </section>
