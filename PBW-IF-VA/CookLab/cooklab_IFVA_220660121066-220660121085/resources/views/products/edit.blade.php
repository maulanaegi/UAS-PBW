<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-2">
        ...
        <div class="flex mt-6 justify-between items-center">
            <h2 class="font-semibold text-xl">Edit Resep</h2>
                ...
                <div class="w-1/2">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="durasi" class="block mt-1 w-full" type="text" name="durasi"
                            :value="$product->durasi" x-mask:dynamic="$money($input, ',')" required />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-area id="deskripsi" class="block mt-1 w-full" type="text"
                            name="deskripsi" rows="10">{{ $product->deskripsi }}</x-text-area>
