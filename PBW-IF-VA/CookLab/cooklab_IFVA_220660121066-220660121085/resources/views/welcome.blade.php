...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-[#f7efda] text-black/50 dark:bg-black dark:text-white/50">
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="flex flex-col md:flex-row items-center gap-2">
                            ...
                            <div class="w-full md:w-1/2">
                                <h1 class="text-3xl text-black">👋 Halo! Senang melihatmu di sini.</h1><br><br>
                                <p class="text-xl text-gray-800 leading-relaxed" style="text-align: justify">
                    ...
                    <footer class="my-16 text-center text-sm text-black dark:text-white/70">
                            <h4>CookLab</h4>
                            <p><q><i>Explore Recipes, Learn Cooking, Enjoy the Lab!</i></q></p>
                            <div class="mt-2">
                              <p>© 2025 CookLab. All rights reserved.</p>
                    </div>                    
                </footer>
                </div>
            </div>
