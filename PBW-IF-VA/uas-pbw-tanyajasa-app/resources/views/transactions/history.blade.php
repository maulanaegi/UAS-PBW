...
@section('container')
  ...
  <div class="container-xxl py-5 bg-dark page-header mb-5">
    <div class="container my-5 pt-5 pb-4">
        <h1 class="display-3 text-white mb-3 animated slideInDown fs-1">{{ $title }}</h1>
    </div>
  </div>
  <!-- Header End -->
  ...
  <div class="container py-5">
      ...
      <div class="card">
          ...
          <div class="card-body">
						<div class="mb-4">
							<h4 style="color: #0077b6;">Total Pendapatan: Rp {{ number_format($totalEarnings, 2, ',', '.') }}</h4>
						</div>
                  ...
                  <tbody>
                      @foreach ($transactions as $transaction)
                          <tr>
                              ...
                              <td>
																@if (!in_array($transaction->status, ['completed', 'canceled']))
																		<button 
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('form .btn-danger').forEach(button => {
