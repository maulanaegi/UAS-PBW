        ...
        <div class="row d-flex flex-wrap justify-content-center">
            ...
            @forelse ($buku as $item)
                <div class="col-auto my-2" style="width:18rem;">
                    <div class="card mx-2 my-2" style="min-height:rem;">
                    @if ($item->gambar != null)
    <img class="card-img-top" style="max-height:260px;" src="{{ asset('storage/' . $item->gambar) }}">
@else
    <img class="card-img-top" style="height:260px;" src="{{ asset('images/noImage.jpg') }}">
@endif
