<div>
    <div class="w-full h-screen bg-gradient-to-r from-white to-blue-900 Blue py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          <!-- Grid -->
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">SHOES <span class="text-black">10KLS'Casuals</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Casuals Style Shoes.</p>
            ...
            <div class="relative ms-4">
              <img class="w-full rounded-md" src="https://i.ibb.co.com/kMH1YC3/10-KLS-Casuals.png" alt="Image Description">
      ...
      <section class="py-20">
        <div class="max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
              <h1 class="text-5xl font-bold dark:text-gray-200"> Browse Popular<span class="text-black"> Brands
                </span> </h1>
        ...
        <div class="justify-center items-center align-middle max-w-6xl px-4 py-4 mx-auto lg:py-0">
      ...
      <div class="bg-white py-20">
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
          <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
            ...
            <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products?selected_categories[0]=<?php echo e($category->id); ?>" wire:key="<?php echo e($category->id); ?>">
              <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                  <div class="flex items-center">
                    <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="https://i.ibb.co.com/p2VvxJQ/casual-style-football-399x500.jpg" alt="StyleCasuals">
                    <div class="ms-3">
...
<?php /**PATH C:\laragon\www\test\resources\views/livewire/home-page.blade.php ENDPATH**/ ?>