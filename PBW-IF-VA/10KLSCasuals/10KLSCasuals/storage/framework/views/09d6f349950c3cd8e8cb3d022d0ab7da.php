<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="lg:pl-20">
              <div class="mb-8 ">
                ...
                <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                  <span><?php echo e(Number::currency($product->price, 'IDR')); ?></span>
              ...
              <div class="flex flex-wrap items-center gap-4">
                <button wire:click='addToCart(<?php echo e($product->id); ?>)' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                  <span wire:loading.remove wire:target='addToCart(<?php echo e($product->id); ?>)'>Add to cart</span><span wire:loading wire:target='addToCart(<?php echo e($product->id); ?>)'>Adding...</span>
                </button>
              </div>
            </div>
          </div>
  ...
  </div><?php /**PATH C:\laragon\www\test\resources\views/livewire/product-detail-page.blade.php ENDPATH**/ ?>