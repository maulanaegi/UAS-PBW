<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800" wire:key='<?php echo e($order->id); ?>'>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?php echo e($order->created_at->format('d-m-y')); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?php echo $status; ?></td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?php echo $payment_status; ?></td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><?php echo e($order->grand_total, 'IDR'); ?></td>
  ...
  </div><?php /**PATH C:\laragon\www\test\resources\views/livewire/my-orders-page.blade.php ENDPATH**/ ?>